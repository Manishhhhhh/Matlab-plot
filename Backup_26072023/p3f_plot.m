...
xlabel(app.p3_UIAxes,app.p3_scaling_struct.axislabel(1));
...
ylabel(app.p3_UIAxes,app.p3_scaling_struct.axislabel(2));
...
ylabel(app.p3_UIAxes,app.p3_scaling_struct.axislabel(3));
...
% str1=str(1:8);
% str2=str(9:end);
% str1(cellfun('isempty',str1)) = [];
% str2(cellfun('isempty',str2)) = [];
% [~,c]=size(str);
...
% legend(app.p3_UIAxes,str2,Location="northwest",Interpreter="none");
